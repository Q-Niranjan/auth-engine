...
api_router.include_router(platform.tenant.router, prefix="/platform/tenants", tags=["platform-tenants"])
...
api_router.include_router(public.introspect.router, prefix="/platform/service-keys", tags=["platform-service-keys"])
